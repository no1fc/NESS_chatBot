...
// ====================================
// 선발형 가점/감점 테이블 (2025~2026 기준 별표 3)
// ====================================
...
export const STATIC_QUESTIONS = [
  ...
  },
  {
    ...
    choices: [
      ...
      { id: 'military', label: '군 복무 중 (전역 2개월 전 제외)', value: '군 복무 중' },
      { id: 'other', label: '직접 입력', value: 'other', isOther: true },
    ],
    showIncomeTable: false
  },
...
2. 기본 자격 확인: 연령(15~69세), 근로능력, 구직 의사
...
[출력 형식 - 반드시 JSON으로만 응답]
{
  ...
  "description": "결과에 대한 상세 설명 (수당 정보, 2~3문장. 불가인 경우 사유 포함)",
  "subType": "특정계층" | "청년" | "중장년" | null (2유형인 경우),
  "tips": [
    "점수 향상 추가팁",
    "추가 안내 사항 (불가인 경우: 자가 진단으로 가입이 가능할 수 있으니 아래 관할 센터로 문의를 추천한다는 뉘앙스의 문안 등)"
  ],
  "phase": "result",
